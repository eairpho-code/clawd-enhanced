...
(function initSettingsI18n(root) {
  const STRINGS = {
    en: {
      ...
      sectionBanter: "Character Banter",
      rowBanterEnabled: "Enable banter",
      rowBanterEnabledDesc: "Show random personality quips above the pet on state changes (thinking, working, error, etc.).",
      rowBanterColor: "Bubble color",
      rowBanterColorDesc: "Background color of the banter speech bubble (hex code).",
      rowBanterOpacity: "Bubble opacity",
      rowBanterOpacityDesc: "Maximum opacity of the banter bubble background.",
      rowBanterScale: "Bubble gap",
      rowBanterScaleDesc: "Distance between the bubble and the pet. 100 = default, higher = farther away.",
